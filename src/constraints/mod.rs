...
pub trait Constraint: DeepSizeOf {
    ...
    fn is_assignment_invalid(&self, node: &dyn ConstraintProperty, child: &dyn ConstraintProperty, assignment: isize) -> bool;
}

pub trait ConstraintProperty: DeepSizeOf {
